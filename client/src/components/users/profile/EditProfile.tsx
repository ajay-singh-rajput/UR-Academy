...
import { RiCloseCircleLine, RiFile2Line, RiImageCircleLine, RiLock2Fill, RiMailLine, RiPhoneLine, RiUser5Line, RiUserLine, RiUserLocationLine } from '@remixicon/react';
